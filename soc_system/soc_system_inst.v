	soc_system u0 (
		...
		.master_ctrl_control_user_base         (<connected-to-master_ctrl_control_user_base>),         //          master_ctrl.control_user_base
		.master_ctrl_control_en                (<connected-to-master_ctrl_control_en>),                //                     .control_en
		.master_ctrl_control_go                (<connected-to-master_ctrl_control_go>),                //                     .control_go
		.master_ctrl_control_state             (<connected-to-master_ctrl_control_state>),             //                     .control_state
		.master_ctrl_control_user_length       (<connected-to-master_ctrl_control_user_length>),       //                     .control_user_length
		.master_write_reset_1_reset            (<connected-to-master_write_reset_1_reset>),            // master_write_reset_1.reset
		...
		.write_control_fixed_location          (<connected-to-write_control_fixed_location>),          //        write_control.fixed_location
		.write_control_write_base              (<connected-to-write_control_write_base>),              //                     .write_base
		.write_control_write_length            (<connected-to-write_control_write_length>),            //                     .write_length
		.write_control_go                      (<connected-to-write_control_go>),                      //                     .go
		.write_control_done                    (<connected-to-write_control_done>),                    //                     .done
		.write_user_write_buffer               (<connected-to-write_user_write_buffer>),               //           write_user.write_buffer
		.write_user_buffer_input_data          (<connected-to-write_user_buffer_input_data>),          //                     .buffer_input_data
		.write_user_buffer_full                (<connected-to-write_user_buffer_full>),                //                     .buffer_full
		.pwm_wire                              (<connected-to-pwm_wire>)                               //                  pwm.wire
	);
